(() => {
  ...
  window.addEventListener("load", function (e) {
    pe(),
      document.querySelector(".care__slider") &&
        new ae(".care__slider", {
          modules: [le, ce],
          observer: !0,
          observeParents: !0,
          ...
          pagination: { el: ".care-pagination", type: "progressbar" },
          on: {},
        }),
      document.querySelector(".gallery__slider") &&
        new ae(".gallery__slider", {
          modules: [le, ce],
          observer: !0,
          observeParents: !0,
          slidesPerView: "auto",
      ...
      document.querySelector(".modern__slider") &&
        new ae(".modern__slider", {
          modules: [le, ce],
          observer: !0,
          observeParents: !0,
          slidesPerView: "auto",
          ...
          pagination: { el: ".modern-pagination", type: "progressbar" },
          on: {},
        }),
      ...
      document.querySelector(".specialists__slider") &&
        new ae(".specialists__slider", {
          modules: [le],
          observer: !0,
          observeParents: !0,
          slidesPerView: 4,
          ...
          breakpoints: {
            ...
            1268: { slidesPerView: 4, spaceBetween: 40 },
          },
          on: {},
        });
  });
  ...
  new he("max").init(),
    window.addEventListener("scroll", function () {
      const e = document.querySelector(".header"),
        t = document.querySelector(".service-main");
      this.window.pageYOffset > t.offsetHeight - e.offsetHeight
        ? e.classList.add("_scroll")
        : e.classList.remove("_scroll");
    });
  const me = document.getElementById("scheme"),
    fe = document.getElementById("footer-scheme");
  function ge() {
    "true" === localStorage.getItem("darkMode")
      ? (localStorage.setItem("darkMode", "false"),
        me.classList.remove("darkMode_active"),
        fe.classList.remove("darkMode_active"),
        document.documentElement.classList.remove("darkMode_active"))
      : (localStorage.setItem("darkMode", "true"),
        me.classList.add("darkMode_active"),
        fe.classList.add("darkMode_active"),
  ...
  null === localStorage.getItem("darkMode") &&
    ...
    me.addEventListener("click", () => {
      document.documentElement.classList.toggle("darkMode_active"),
        me.classList.toggle("darkMode_active"),
        fe.classList.toggle("darkMode_active"),
        ge();
    }),
